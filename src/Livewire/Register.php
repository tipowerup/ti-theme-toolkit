...
use TiPowerUp\ThemeToolkit\Livewire\Forms\RegisterForm;
...
class Register extends Component
{
    ...
    public static function componentMeta(): array
    {
        return [
            'code' => '{ns}::register',
            'name' => '{lang}::default.component_register_title',
            'description' => '{lang}::default.component_register_desc',
        ];
    }
    ...
    {
        return view($this->resolveViewNamespace().'::livewire.register');
    }
